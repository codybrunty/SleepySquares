...
public class Tutorial_Instructions_11 : MonoBehaviour{
    ...
    private void OnEnable() {
        ...
        StartCoroutine(Tutorial11_Animations());
    }

    IEnumerator Tutorial11_Animations() {
        PunchGreen();
        PunchNextSquare();
    ...
    private void CloseEyelid2() {
        ...
        hash.Add("position", new Vector3(.2077137f, 2.011361f, 0f));
        hash.Add("time", 0.25f);
        hash.Add("oncomplete", "SwitchEyelidGraphics2");
        hash.Add("oncompletetarget", gameObject);

        Hashtable hash2 = new Hashtable();
        hash2.Add("scale", new Vector3(.7208953f, .5348245f, 1f));
    ...
    private void CloseEyelid1() {
        ...
        Hashtable hash = new Hashtable();
        hash.Add("position", new Vector3(0.55194f, 3.481283f, 0f));
        hash.Add("time", 0.25f);
    ...
    private void MoveAndScaleClickNext() {
        clickNext.transform.localPosition = new Vector3(1.887f, 2.439f, 5f);
        clickNext.transform.localScale = new Vector3(3.014194f, 6.883603f, 3.987f);
    }
